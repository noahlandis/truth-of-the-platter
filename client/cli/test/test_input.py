...
from ..src.input import read_input, get_intended_restaurant
...
def test_get_intended_restaurant_one_match():
    ...
    actual = get_intended_restaurant(yelp_potential_matches)
    assert actual == expected
...
def test_get_intended_restaurant_errors(mock_input: Mock, mock_print: Mock, side_effect):
    ...
    mock_input.side_effect = side_effect
    get_intended_restaurant(yelp_potential_matches)
